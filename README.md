...
- Dedicated to **Hardware & Software Integration**, with expertise ranging from digital electronics to web and game development.
...
## Life Experiences
- **Event Coordinator** — SCIST x SCAICT 2026 Joint Winter Camp.
- **Field Affairs Team Member** — 2026 g0v Summit.
- **Member** — AIS3 CLUB (Cloud Chiayi Cybersecurity Experience Camp).
